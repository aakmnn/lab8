...
import random
import time
from itertools import chain #для объединения диапазонов чисел.
...
#scores
score = 0
coin_score = 0 #счет за избегание врагов и сбор монет.
...
#bg image
background = pygame.image.load("/Users/macos/Desktop/lab8/images/AnimatedStreet.png")


#screen and frame counter
#это экран игры, на который будут рисоваться все элементы.
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/macos/Desktop/lab8/images/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/Users/macos/Desktop/lab8/images/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, enemy):
        super().__init__()
        self.image = pygame.image.load("/Users/macos/Desktop/lab8/images/coin.png")
        self.rect = self.image.get_rect()
...
while loop:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("/Users/macos/Desktop/lab8/images/crash.wav").play()
        time.sleep(5)
    ...
    if pygame.sprite.spritecollide(P1, coins_group, dokill=True):
        pygame.mixer.Sound("/Users/macos/Desktop/lab8/images/getcoin.mp3").play()
        coin_score += 1
        coin = Coin(E1)
        coins_group.add(coin)
